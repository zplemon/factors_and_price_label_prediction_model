...
class GA:
    ...
    def IntialPopulation(self):
        ...
        prob, _, fitness = self.Fitness(self.population)
        self.bestFitnessList.append(np.max(prob))
        self.bestAccuracyList.append(np.max(fitness))
    ...
    def Fitness(self, population):
        ...
        for i in range(self.populationSize):
            ...
            eva = EvaluationClass(X_train_masked, self.Y_train, X_test_masked, self.Y_test, self.model_type,
                                  self.save_computaion)
            fitness[i] = eva.evalu()
    ...
    def Search(self):
        ...
        self.bestAccuracy = np.max(self.bestAccuracyList)
